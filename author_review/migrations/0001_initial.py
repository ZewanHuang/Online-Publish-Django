    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(0, '审核中'), (1, '已分配'), (2, '待处理'), (3, '审核不通过'), (4, '已发布')], default=0)),
                ('read_num', models.IntegerField(default=0)),
                ('download_num', models.IntegerField(default=0)),
                ('article_address', models.FileField(blank=True, upload_to=author_review.models.file_directory_path)),
