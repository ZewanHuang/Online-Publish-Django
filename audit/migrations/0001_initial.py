    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='audit.review')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='article',
            name='remarks',
            field=models.ManyToManyField(through='audit.ArticleRemark', to='audit.Review'),
        ),
        migrations.AddField(
            model_name='article',
            name='writers',
            field=models.ManyToManyField(to='audit.Writer'),
        ),
    ]
